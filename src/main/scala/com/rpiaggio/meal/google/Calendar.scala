...
object Calendar extends FeedList {
  ...
  val feeds = Map(
    "calendar-rpiaggio" -> buildFeed("My Calendar", uri"https://calendar.google.com/calendar/ical/rpiaggio%40gmail.com/private-0980ea4c2b25f1a2f780ce32c98a1484/basic.ics"),
  )
}
